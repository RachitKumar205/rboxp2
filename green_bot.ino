...
#define speedturn 90 // edit this to determine the speed during taking turns
...
#define Hspeedturn 50
#define led 11
#define sensor A0
#define obstacle 12
#define delayspeed 120
...
void MazeSolve()
{
  ...
  digitalLow( leftMotor1 );
  digitalHigh( leftMotor2 );
      analogWrite(rightMotorPWM, delayspeed);
      analogWrite(leftMotorPWM, delayspeed);
      for (int i = 0; i < 30; i++)
      {
  ...
  digitalHigh( leftMotor2 );
      analogWrite(rightMotorPWM, delayspeed);
      analogWrite(leftMotorPWM, delayspeed);
      delay(120);                        //TIME  BEFORE TAKING LEFT TURN DURING SEARCH RUN
    }
   ...
   while (1)
    ...
    for (int i = 0; i < path_length; i++)
    {
      ...
      {  digitalLow( rightMotor2 );
        ...
        analogWrite(rightMotorPWM, delayspeed);
        analogWrite(leftMotorPWM, delayspeed);
        delay(140);                          //TIME  BEFORE TAKING RIGHT TURN DURING ACTUAL  RUN
      }
